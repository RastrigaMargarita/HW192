    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=15, verbose_name='Country')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.countries')),
